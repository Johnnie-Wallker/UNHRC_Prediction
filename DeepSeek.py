...
# 1轮无样例准确率(细节)：0.6934673366834171
# 1轮有样例准确率：0.6450287592440427
# 1轮有样例准确率(细节)：0.695142378559464
# 1轮有总结文本准确率(细节)：0.6909547738693468
# 1轮RuleSet准确率(细节)：0.6670854271356784

# 2轮无样例准确率：0.6798088410991637
# 2轮无样例准确率(细节)：0.6650602409638554
# 2轮有样例准确率：0.6738351254480287
# 2轮有样例准确率(细节)：0.7024096385542169
# 2轮有总结文本准确率(细节)：0.691566265060241
# 2轮RuleSet准确率(细节)：0.6590361445783133
