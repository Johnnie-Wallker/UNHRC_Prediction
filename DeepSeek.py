...
# 简历筛选轮：
# 1.无样例 准确率为：0.650 召回率为：0.472
# 2.有样例 准确率为：0.639 召回率为：0.455
# 3.无样例(细节) 准确率为：0.702 召回率为：0.550
# 4.有样例(细节) 准确率为：0.704 召回率为：0.554
# 5.有总结文本(细节) 准确率为：0.693 召回率为：0.537
# 6.RuleSet(细节) 准确率为：0.660 召回率为：0.486
# 7.Prototype(细节) 准确率为：0.665 召回率为：0.495

# 面试轮：
# 1.无样例 准确率为：0.651 召回率为：0.225
# 2.有样例 准确率为：0.651 召回率为：0.225
# 3.无样例(细节) 准确率为：0.660 召回率为：0.246
# 5.有总结文本(细节) 准确率为：0.699 召回率为：0.332
# 6.RuleSet(细节) 准确率为：0.670 召回率为：0.267
